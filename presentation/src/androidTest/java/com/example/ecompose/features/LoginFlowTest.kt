package com.example.ecompose.features
...
import com.example.ecompose.MainActivity
...
class LoginFlowTest : KoinTest {
    ...
    fun loginWithWrongCredentials() {
        waitForLoginScreen()
        composeTestRule.onNodeWithTag("emailField").performTextInput("wrongCredentials@gmail.com")
        composeTestRule.onNodeWithTag("passwordField").performTextInput("123456")
        composeTestRule.onNodeWithTag("loginButton").performClick()
        waitForErrorScreen()
    }
